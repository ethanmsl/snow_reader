...
// pub fn snow_example_search<P>(path: Option<&P>) -> Result<String>
//         where P: AsRef<Path>
// {
//         Ok(match path {
//                 Some(path) => fs::read_to_string(path)?,
//                 None => fs::read_to_string(EXAMPLE_SEARCH_INCLUDE)?,
//         })
// }
...
// ///             - various
// ///             - ...
// pub fn snow_example_short<P>(path: Option<&P>) -> Result<String>
//         where P: AsRef<Path>
// {
//         Ok(match path {
//                 Some(path) => fs::read_to_string(path)?,
//                 None => fs::read_to_string(EXAMPLE_SCRIPT_ACTION)?,
//         })
// }
